...
function() {
  if (KTSEnv$activMenu != "analymenu") {
    ...
    subMenu3But(parent = row232, text = "Recurrence matrix", 
                command = createSimpleRM)
    subMenu3But(parent = row232, text = "Cross recurrence matrix", 
                command = createCrossRM)
    subMenu3But(parent = row232, text = "Joint recurrence matrix", 
